...
const HeroCarousel = () => {
    ...
    return (
        <section className="relative  min-h-[500px] sm:min-h-[500px] md:min-h-[550px] lg:min-h-[600px] flex items-center justify-center text-center text-white overflow-hidden">
            <AnimatePresence>
                <motion.div
                    key={currentIndex}
                    initial={{ opacity: 0 }}
