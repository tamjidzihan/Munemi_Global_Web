...
const AgentSignIn: React.FC = () => {
    const { loginAgent, agent, loading, error, applicationInfo } = useAgentAuth();
    ...
    const handleSignIn = async (event: React.FormEvent) => {
        ...
        const success = await loginAgent(businessRegistrationNumber);
        if (success) {
            setAlertMessage('Welcome Agent')
        } else {
            if (error) {
    ...
    if (agent) return <Navigate to="/studentenquiry" />;
                ...
                <div className="flex flex-wrap items-center">
                    <div className="hidden w-full xl:block xl:w-1/2">
                        <div className="py-17.5 px-26 text-center">
                            <NavLink to="/">
                                <div className='pl-5 text-3xl font-bold text-midnight'>Munemi Global</div>
                            </NavLink>
                            ...
                            <span className="mt-15 inline-block">
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M203.062 278.617H170.680C170.121 278.617 169.584 278.394 169.189 277.999C168.793 277.604 168.571 277.068 168.57 276.509V265.168C168.571 264.609 168.793 264.073 169.189 263.678C169.584 263.283 170.121 263.06 170.680 263.06H203.062C203.621 263.06 204.158 263.283 204.553 263.678C204.949 264.073 205.171 264.609 205.172 265.168V276.509C205.171 277.068 204.949 277.604 204.553 277.999C204.158 278.394 203.621 278.617 203.062 278.617Z"
                                        fill="#3056D3"
                                    />
                                    <path
                                        d="M116.263 203.477C118.050 203.477 119.499 202.029 119.499 200.243C119.499 198.457 118.050 197.01 116.263 197.01C114.476 197.01 113.027 198.457 113.027 200.243C113.027 202.029 114.476 203.477 116.263 203.477Z"
                                        fill="#3056D3"
                                    />
                                    <path
                                    ...
                                    />
                                    <path
                                        d="M116.263 235.811C118.050 235.811 119.499 234.363 119.499 232.577C119.499 230.791 118.050 229.344 116.263 229.344C114.476 229.344 113.027 230.791 113.027 232.577C113.027 234.363 114.476 235.811 116.263 235.811Z"
                                        fill="#3056D3"
                                    />
                                    <path
                                    ...
                                    />
                                    <path
                                        d="M298.642 344.352H292.894L290.160 322.198L298.643 322.198L298.642 344.352Z"
                                        fill="#FFB8B8"
                                    />
                                    <path
                                    ...
                                    />
                                    <path
                                        d="M316.556 202.365C321.672 204.17 322.573 223.716 322.573 223.716C316.554 220.409 309.332 225.821 309.332 225.821C309.332 225.821 307.827 220.709 306.022 214.094C305.477 212.233 305.412 210.265 305.832 208.372C306.253 206.479 307.147 204.724 308.429 203.269C308.429 203.269 311.440 200.56 316.556 202.365Z"
                                        fill="#3056D3"
                                    />
                                    <path
                                        d="M310.566 183.213C309.132 182.066 307.174 184.151 307.174 184.151L306.026 173.828C306.026 173.828 298.853 174.687 294.261 173.542C289.67 172.396 288.953 177.7 288.953 177.7C288.716 175.557 288.668 173.399 288.810 171.248C289.096 168.667 292.827 166.087 299.427 164.366C306.026 162.646 309.470 170.101 309.470 170.101C314.061 172.395 312.001 184.36 310.566 183.213Z"
                                        fill="#1C2434"
                                    />
                                </svg>
                            </span>
                    ...
                    <div className="w-full border-stroke xl:w-1/2 xl:border-l-2">
                        <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                            {showAlert && <Alert message={alertMessage} type="error" onClose={() => setShowAlert(false)} />}

                            {applicationInfo && (
                                <div className={`mb-4 p-4 rounded-lg ${applicationInfo.applicationStatus === 'pending'
                                    ? 'bg-yellow-100 border border-yellow-400 text-yellow-700'
                                    : 'bg-red-100 border border-red-400 text-red-700'
                                    }`}>
                                    <h3 className="font-bold mb-2">
                                        Application Status: {applicationInfo.applicationStatus?.toUpperCase()}
                                    </h3>
                                    <p>{applicationInfo.message}</p>
                                    {applicationInfo.applicationStatus === 'rejected' && applicationInfo.rejectionReason && (
                                        <p className="mt-2">
                                            <strong>Reason:</strong> {applicationInfo.rejectionReason}
                                        </p>
                                    )}
                                </div>
                            )}
                            ...
                            <form onSubmit={handleSignIn}>
                                ...
                                <div className="mb-5">
                                    <button
                                        ...
                                        disabled={loading || !businessRegistrationNumber.trim()}
                                    >
                                        {loading ? (
                                            <svg
                                ...
                                <div className="mt-6 text-center">
                                    <p>
                                        ...
                                        <Link to="/career/agents-application" className="text-primary">
                                            Apply Now
                                        </Link>
                                    </p>
                                </div>
