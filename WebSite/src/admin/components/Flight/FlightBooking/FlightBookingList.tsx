...
import { Booking } from "../../../../hooks/useFlightBookings";
import { Minus } from "lucide-react";
import CreateFlightBookingModal from "./CreateFlightBookingModal";
...
const FlightBookingList = ({ allBookings, deleteBooking }: FlightBookingListProps) => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [bookingList, setBookingList] = useState<Booking[]>(allBookings);

    useEffect(() => {
        setBookingList([...allBookings].sort((a, b) =>
            ...
            {bookingList.length > 0 ? (
                bookingList.map((booking) => (
                    ...
                    >
                        ...
                        <div className="col-span-1 flex items-center">
                            <p className="overflow-hidden">{booking.origin || "N/A"}</p>
                        </div>
                        <div className="col-span-1 flex items-center">
                            <p className="overflow-hidden">{booking.destination || "N/A"}</p>
                        </div>
                        <div className="col-span-1 flex items-center">
                            <p className="overflow-hidden">{formatDate(booking.startDate) || "N/A"}</p>
                        </div>
                        <div className="col-span-1 flex items-center">
                            {booking.endDate
                                ? <p className="overflow-hidden">{formatDate(booking.endDate) || "N/A"}</p>
                                : <p className="overflow-hidden"> "N/A"</p>
                            }
                        </div>
                        <div className="col-span-1 flex items-center">
                            <p className="text-sm">
                ...
                <p className="text-gray-500">No Flight Bookings available.</p>
            </div>
            }
        </div>
    );
