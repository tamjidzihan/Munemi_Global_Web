...
import useFlightBookings, { Booking } from "../../../../hooks/useFlightBookings";

type CreateFlightBookingModalProps = {
    isOpen: boolean;
    closeModal: () => void;
    addNewBooking: (newBooking: Booking) => void;
};

const CreateFlightBookingModal = ({
    isOpen,
    closeModal,
    addNewBooking,
}: CreateFlightBookingModalProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(error);
            alert("Failed to create flight booking.");
        } finally {
            // Reset form fields
            setFormData({
                fullName: '',
    ...
    return (
        <div className="inset-0 py-10 flex items-center justify-center bg-gray-200 shadow-2xl">
            <div className="bg-white p-6 rounded-lg shadow-lg w-3/4">
                <h3 className="text-xl font-semibold mb-4">New Flight Booking</h3>
                <form onSubmit={handleSubmit} className={`${loading ? "opacity-50 pointer-events-none" : ""}`}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            onChange={(e) => setFormData({ ...formData, adult: parseInt(e.target.value) })}
                            className="w-full p-2 border border-gray-300 rounded-md focus:outline-blue-500"
                            disabled={loading}
                            required
                        />
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium mb-2">Children (Optional)</label>
                        <input
                            type="number"
                            min="0"
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium mb-2">Infants (Optional)</label>
                        <input
                            type="number"
                            min="0"
...
export default CreateFlightBookingModal;