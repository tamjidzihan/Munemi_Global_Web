...
const CreateOffersModal = ({
    ...
    const { imageUrl, publicId, loading: imageLoading, uploadImage } = useImageUploadDelete();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (selectedImage) {
            ...
            imageUrlRef.current = imageUrl; // Update ref with the latest imageUrl
            publicIdRef.current = publicId; // Update ref with the latest publicId
        }
    ...
    return (
        <div className="inset-0 flex items-center justify-center bg-gray-200  shadow-2xl">
                        ...
                        <div className="rounded-sm border border-stroke bg-white shadow-default ">
                            ...
                            <div className="p-7">
                                ...
                                <div className="flex justify-end gap-4.5">
                                    ...
                                    <button
                                        className="flex justify-center rounded hover:bg-blue-700 bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-90 cursor-pointer"
                                        type="button"
