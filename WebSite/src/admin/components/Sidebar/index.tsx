...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-background duration-300 ease-linear bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/adminpanel">
          <div className=' pl-5 text-xl font-bold text-white'>Munemi Global</div>
        </NavLink>
        ...
        <nav className=" py-4 px-4 lg:px-6">
          ...
          <div>
            ...
            <div className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <div className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <div>
                            <NavLink
                              to="/adminpanel/package/packagelist"
                              className={({ isActive }) =>
                          ...
                          <div>
                            <NavLink
                              to="/adminpanel/package/packagebooking"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md pb-1 px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
              ...
              {/* <!-- Menu Item Career Settings --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/career' || pathname.includes('career')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/career' ||
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/flight' || pathname.includes('flight')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark  ${(pathname === '/flight' ||
          ...
          <div>
            ...
            <div className="mb-6 flex flex-col gap-1.5">
              ...
              <div>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-message-square-text-icon lucide-message-square-text"
                  >
              ...
              <div>
                <NavLink
                  to="/adminpanel/newsheadline"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('newsheadline') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-newspaper-icon lucide-newspaper">
                    <path d="M15 18h-5" />
                    <path d="M18 14h-8" />
