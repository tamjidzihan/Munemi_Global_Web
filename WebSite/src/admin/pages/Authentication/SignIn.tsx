...
const SignIn: React.FC = () => {
  ...
  const handleSignUp = (event: React.FormEvent) => {
    event.preventDefault();
    setError('Sign Up temporarily disabled');
    setShowAlert(true);
  ...
  if (user) return <Navigate to="/adminpanel" />;

  return (
    <>
      <Navbar />
      <div className="max-w-[1440px] mx-auto p-8 rounded-sm mt-15 lg:my-20 border border-stroke bg-white shadow-default ">
              ...
              <form onSubmit={handleSignIn}>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <button onClick={handleSignUp} className="text-primary cursor-pointer">
                      Sign Up
                    </button>
                  </p>
                </div>
