...
const AppointmentsList = ({ allAppointments, deleteAppointment }: AppointmentsListProps) => {
  const { createAppointment, setAppointments } = useAppointments()
  const [isModalOpen, setIsModalOpen] = useState(false);

  const addNewAppointment = (newAppointment: Appointment) => [
    setAppointments(pervAppointment => [newAppointment, ...pervAppointment,])
  ]
        ...
        allAppointments.map((appointment: Appointment) => (
          ...
          >
            <div className="col-span-1 flex  items-center mr-3">
              <p className=' overflow-hidden'>{appointment.firstName}</p>
            </div>
            <div className="col-span-1 flex  items-center mr-3">
              <p className=' overflow-hidden'>{appointment.lastName}</p>
            </div>
            <div className="col-span-1 flex  items-center mr-3">
              <p className=' overflow-hidden'>{appointment.phone}</p>
            </div>
            <div className="col-span-2 flex  items-center mr-3">
              <p className=' overflow-hidden'>{appointment.email}</p>
            </div>
            <div className="col-span-1 flex  items-center mr-3">
