...
import { HealthInsurancePartner } from "../../../hooks/useHealthInsurancePartners";
import { Minus } from "lucide-react";
import CreateHealthInsurancePartnerModal from "./CreateHealthInsurancePartnerModal";

type HealthInsurancePartnerListProps = {
    allPartners: HealthInsurancePartner[];
...
const HealthInsurancePartnerList = ({ allPartners, deletePartner }: HealthInsurancePartnerListProps) => {
    ...
    const addNewPartner = (newPartner: HealthInsurancePartner) => {
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default">
            <div className="py-6 px-4 md:px-6 xl:px-7.5 flex justify-between">
                <h4 className="text-xl place-self-center font-semibold text-midnight">
                    List of Health Insurance Partners
                </h4>
                <button
                ...
                >
                    ...
                    {isModalOpen ? `Cancel` : ` Create New Health Insurance Partner`}
                </button>
            </div>

            {/* Create Partner Modal */}
            <CreateHealthInsurancePartnerModal
            ...
            <div className="grid bg-cyan-50 text-midnight border-t border-stroke py-4.5 px-4 sm:grid-cols-10 md:px-6 2xl:px-7.5">
                ...
                <div className="col-span-1 flex items-center">
                    <p className="font-bold">Business Reg. No.</p>
                </div>
                <div className="col-span-1 flex items-center">
            ...
            {partnerList.length > 0 ? (
                partnerList
                    ...
                    .map((partner: HealthInsurancePartner) => (
                        ...
                        >
                            ...
                            <div className="col-span-1 flex items-center mr-3">
                                <p className="overflow-hidden">{partner.officePhoneNumber || "N/A"}</p>
                            </div>
                            <div className="col-span-1 flex items-center mr-3">
                                <p className="overflow-hidden">{partner.countryLocated || "N/A"}</p>
                            </div>
                            <div className="col-span-1 flex items-center mr-3">
                                <p className="overflow-hidden">{partner.primaryOfficeLocation || "N/A"}</p>
                            </div>
                            <div className="col-span-1 flex items-center mr-3">
                                <p className="overflow-hidden">{partner.website || "N/A"}</p>
                            </div>
                            <div className="col-span-1 flex items-center mr-3">
                ...
                <div className="text-center py-4">
                    <p className="text-gray-500">No Health Insurance Partners available.</p>
                </div>
            )}
        </div>
    );
...
export default HealthInsurancePartnerList;