        ...
        <div className=" relative rounded-sm border border-stroke bg-white shadow-default ">
            <div className="py-6 px-4 md:px-6 xl:px-7.5 flex justify-between">
                ...
                <button
                    ...
                    {isModalOpen ? `Cancel` : ` Create New Student Enquiry`}
                </button>
            </div>
            ...
            {/* List of Events */}
            {
                studentEnquiryList.length > 0 ? (
                        ...
                        .map((studentEnquiry: StudentEnquiry) => (
                            ...
                            >
                                <div className="col-span-1 flex  items-center mr-3">
                                    <p className=' overflow-hidden'>{studentEnquiry.studentName}</p>
                                </div>
                                <div className="col-span-2 flex  items-center mr-3">
                                    <p className=' overflow-hidden'>{studentEnquiry.email}</p>
                                </div>
                                <div className="col-span-1 flex  items-center mr-3">
                                    <p className=' overflow-hidden'>{studentEnquiry.phone}</p>
                                </div>
                                <div className="col-span-2 flex  items-center mr-3">
                    ...
                    <div className="text-center py-4">
                        <p className="text-gray-500">No Student Enquiry available.</p>
                    </div>
                )
            }
        </div >
